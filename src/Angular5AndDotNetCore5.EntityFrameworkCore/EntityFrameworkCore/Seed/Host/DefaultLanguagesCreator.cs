...
namespace Angular5AndDotNetCore5.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = Angular5AndDotNetCore5Consts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(Angular5AndDotNetCore5DbContext context)
        {
            _context = context;
        }
