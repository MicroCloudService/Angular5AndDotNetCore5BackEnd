...
namespace Angular5AndDotNetCore5.Controllers
{
    ...
    public class TokenAuthController : Angular5AndDotNetCore5ControllerBase
    {
        ...
        {
            return SimpleStringCipher.Instance.Encrypt(accessToken, Angular5AndDotNetCore5Consts.DefaultPassPhrase);
        }
    }
}
