...
using Shouldly;
using Xunit;
using Angular5AndDotNetCore5.Sessions;

namespace Angular5AndDotNetCore5.Tests.Sessions
{
    public class SessionAppService_Tests : Angular5AndDotNetCore5TestBase
    {
