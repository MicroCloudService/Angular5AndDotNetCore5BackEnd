...
{
    public abstract class Angular5AndDotNetCore5WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Angular5AndDotNetCore5WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Angular5AndDotNetCore5WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Angular5AndDotNetCore5DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Angular5AndDotNetCore5DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Angular5AndDotNetCore5DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Angular5AndDotNetCore5DbContext, Task<T>> func)
        {
            T result;
